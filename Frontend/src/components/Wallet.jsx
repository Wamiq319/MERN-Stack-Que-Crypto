  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 bg-transparent rounded-lg">
      <div
        ...
        className="relative z-10 bg-white px-4 py-3 rounded-lg shadow-xl space-y-6 hover:scale-110 transform transition-all duration-1000"
      >
        {!userDetails && (
          ...
          <div className="relative z-10 mt-8 space-y-6">
            ...
            <div className="flex justify-between md:gap-3 gap-1 mt-8 ">
              <div className="w-1/3 bg-white p-4 rounded-lg shadow-md">
                <h4 className="text-lg font-semibold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400">
                  Wallet Balance
                </h4>
            ...
            <div className="flex justify-between mt-6 space-x-4">
              <button className="px-6 py-2 text-sm sm:text-base text-green-400 border border-green-400 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-green-500 hover:text-white hover:shadow-lg">
                WithDraw
              </button>
              <button
                onClick={() => setUserDetails(null)}
                className="px-6 py-2 text-sm sm:text-base text-red-400 border border-red-400 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-red-500 hover:text-white hover:shadow-lg"
              >
                Logout
              </button>
            </div>
